...
const DEFAULT_PLANS = [
  {
    ...
    features: [
      ...
      'Academic Management',
      'Fee Management',
      'Hostel Management (Rooms, Mess & Fees)',
  ...
  },
  {
    ...
    finalPrice: 3000,
    currency: 'INR',
    description: 'Quarterly subscription plan offering ₹600 instant savings.',
    offerTitle: 'Save ₹600',
    offerDescription: 'Save ₹600 on quarterly billing (90 days access).',
    badge: 'POPULAR',
    isTrial: false,
    isActive: true,
    displayOrder: 2,
  ...
  },
  {
    ...
    finalPrice: 10800,
    currency: 'INR',
    description: 'Annual subscription offering 25% maximum savings and priority support.',
    offerTitle: 'Save ₹3,600',
    offerDescription: '25% OFF on yearly billing (365 days access).',
    badge: 'BEST VALUE',
    isTrial: false,
    isActive: true,
    displayOrder: 3,
