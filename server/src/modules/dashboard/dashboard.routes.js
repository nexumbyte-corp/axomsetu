...
import { getDashboardSummary, getDailyCollection, getDailyExpenses } from './dashboard.controller.js';
...
router.get('/daily-expenses', requirePermission(PERMISSIONS.DASHBOARD_VIEW), getDailyExpenses);
