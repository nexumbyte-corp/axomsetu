export const REPORT_CATEGORIES = [
  ...
  { id: 'hostel', title: 'Hostel Reports', icon: 'Building' },
...
export const REPORT_REGISTRY = [
  ...
  // --- Hostel Reports ---
  {
    id: 'hostel-residents-report',
    category: 'hostel',
    title: 'Current Active Residents',
    description: 'Master directory of all students currently residing in hostel rooms with class and guardian info.',
    endpoint: '/hostel/reports/residents',
    pdfTemplate: 'hostelReport',
    filters: ['academicYearId', 'search'],
    columns: [
      { key: 'studentName', label: 'Student Name', bold: true },
  ...
  {
    id: 'hostel-occupancy-report',
    category: 'hostel',
    title: 'Hostel Occupancy Report',
    description: 'Occupancy statistics, total capacity, occupied beds, available beds, and utilization rate across hostels.',
    endpoint: '/hostel/reports/occupancy',
    pdfTemplate: 'hostelReport',
    filters: [],
    columns: [
      { key: 'hostelName', label: 'Hostel Name', bold: true },
      ...
      { key: 'occupancyRate', label: 'Occupancy (%)', bold: true },
    ],
  },
  {
    id: 'hostel-bed-availability-report',
    category: 'hostel',
    title: 'Bed Availability Directory',
    description: 'Room-by-room breakdown of bed capacity, occupancy, and vacant bed numbers.',
    endpoint: '/hostel/reports/availability',
    pdfTemplate: 'hostelReport',
    filters: [],
    columns: [
      { key: 'hostelName', label: 'Hostel', bold: true },
      { key: 'roomNumber', label: 'Room' },
      { key: 'floor', label: 'Floor' },
      { key: 'capacity', label: 'Capacity' },
      { key: 'availableBedsCount', label: 'Free Beds' },
      { key: 'availableBedNumbers', label: 'Vacant Bed Labels' },
    ],
  },
  {
    id: 'hostel-admissions-log-report',
    category: 'hostel',
    title: 'Hostel Admissions Log',
    description: 'Chronological register of student admissions and bed allotments to hostels.',
    endpoint: '/hostel/reports/admissions',
    pdfTemplate: 'hostelReport',
    filters: ['academicYearId', 'startDate', 'endDate', 'search'],
    columns: [
      { key: 'startDate', label: 'Admission Date', type: 'date' },
      { key: 'studentName', label: 'Student Name', bold: true },
      { key: 'admissionNo', label: 'Adm No' },
      { key: 'className', label: 'Class' },
      { key: 'hostelName', label: 'Hostel' },
  ...
  {
    id: 'hostel-fees-ledger-report',
    category: 'hostel',
    title: 'Hostel Fees Ledger',
    description: 'Hostel fee charges, monthly billings, collections, and outstanding dues statement.',
    endpoint: '/hostel/reports/fees',
    pdfTemplate: 'hostelReport',
    filters: ['academicYearId', 'startDate', 'endDate', 'search'],
    columns: [
      { key: 'studentName', label: 'Student Name', bold: true },
