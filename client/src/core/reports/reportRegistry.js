...
export const REPORT_REGISTRY = [
  ...
  },
  {
    ...
    description: 'Track staff salary advances issued, amounts recovered via payroll, and remaining balances.',
    ...
    columns: [
      ...
      { key: 'staffName', label: 'Staff Name', bold: true },
      { key: 'employeeId', label: 'Emp ID' },
      { key: 'amount', label: 'Advance Amount (₹)', type: 'currency', align: 'right' },
      { key: 'recovered', label: 'Recovered (₹)', type: 'currency', align: 'right' },
      { key: 'balance', label: 'Remaining Balance (₹)', type: 'currency', align: 'right', highlight: true },
      { key: 'paymentMode', label: 'Payment Mode', type: 'badge' },
    ],
  },
  {
